...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_status'])) {
    ...
    if ($stmt->execute()) {
        ...
        header("Location: customer_orders.php?message=Order+status+updated+successfully&alert=success");
    } else {
        // Redirect with error message
        header("Location: customer_orders.php?message=Error+updating+status&alert=danger");
    }
